...
SEER_ANCESTRY_FILE = "seer_ancestry_clean.csv"
SEER_SEX_FILE = "seer_sex_clean.csv"
...
def make_figure2(htan_ancestry_table, seer_ancestry_shares, ancestry_order,
    ...
    print("Saved: figure2_reproduction.png")
...
def analyze_ancestry():
    ...
    results_df.to_csv("htan_vs_seer_ancestry_chisq.csv", index=False)
...
def analyze_sex():
    ...
    print(results_df.to_string(index=False))
    results_df.to_csv("htan_vs_seer_sex_chisq.csv", index=False)
