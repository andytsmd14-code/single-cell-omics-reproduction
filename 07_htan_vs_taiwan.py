...
HTAN_FILE = "htan_clean.csv"
TAIWAN_FILE = "taiwan_reference_clean_en.csv"
...
def main():
    ...
    results_df.to_csv("htan_vs_taiwan_sex_comparison.csv", index=False)
    print("\nSaved: htan_vs_taiwan_sex_comparison.csv")
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("figure_htan_vs_taiwan_sex.png", dpi=150, bbox_inches="tight")
    print("Saved: figure_htan_vs_taiwan_sex.png")
