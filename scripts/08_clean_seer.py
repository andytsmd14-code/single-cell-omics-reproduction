...
INPUT_FILE = "../data/SEER_combined_cancer_demographics.csv"
...
if __name__ == "__main__":
    ...
    ancestry_clean.to_csv("../outputs/seer_ancestry_clean.csv", index=False)

    print("\n=== SEER Sex Reference (rate per 100,000) ===")
    print(sex_clean.to_string(index=False))
    sex_clean.to_csv("../outputs/seer_sex_clean.csv", index=False)

    print("\nSaved: ../outputs/seer_ancestry_clean.csv, ../outputs/seer_sex_clean.csv")
