...
def plot_ancestry_by_tissue(df):
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("../figures/figure1C_reproduction.png", dpi=150, bbox_inches="tight")
    print("Saved: ../figures/figure1C_reproduction.png")
...
def plot_sex_by_tissue(df):
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("../figures/figure1E_reproduction.png", dpi=150, bbox_inches="tight")
    print("Saved: ../figures/figure1E_reproduction.png")
