...
INPUT_FILE = "../data/ADRD_disease_demographics_wide.csv"
...
if __name__ == "__main__":
    ...
    sex_ref.to_csv("../outputs/adrd_sex_reference_clean.csv", index=False)
    ...
    ancestry_ref.to_csv("../outputs/adrd_ancestry_reference_clean.csv", index=False)

    print("\nSaved: ../outputs/adrd_sex_reference_clean.csv, ../outputs/adrd_ancestry_reference_clean.csv")
