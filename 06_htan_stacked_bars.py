...
def plot_ancestry_by_cancer(df):
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("figure2A_htan_only.png", dpi=150, bbox_inches="tight")
    print("Saved: figure2A_htan_only.png")
...
def plot_sex_by_cancer(df):
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("figure2C_htan_only.png", dpi=150, bbox_inches="tight")
    print("Saved: figure2C_htan_only.png")
