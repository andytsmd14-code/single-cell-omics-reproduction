...
PSYCHAD_FILE = "psychad_clean.csv"
ADRD_SEX_FILE = "adrd_sex_reference_clean.csv"
ADRD_ANCESTRY_FILE = "adrd_ancestry_reference_clean.csv"
...
def panel_D(ax, df, adrd_sex):
    ...
    results_df.to_csv("psychad_vs_adrd_sex_chisq.csv", index=False)
