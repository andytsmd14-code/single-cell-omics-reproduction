...
def analyze_ancestry(df):
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("figure1B_reproduction.png", dpi=150, bbox_inches="tight")
    print("Saved: figure1B_reproduction.png")
...
def analyze_sex(df):
    ...
    plt.tight_layout()
    add_caption(fig)
    plt.savefig("figure1D_reproduction.png", dpi=150, bbox_inches="tight")
    print("Saved: figure1D_reproduction.png")
